...
class _EventsState extends State<Events> {
  ...
  Widget build(BuildContext context) {
    ...
    List<EventCard> events = [
      ...
      EventCard(title: "item 2",date: new DateTime(2020,DateTime.august,9), description: garbage,location: "Floating Platform@Marina Bay",attended: true,),
      EventCard(title: "item 3",date: new DateTime(2020,DateTime.january,23), description: garbage,location: "Marina Bay Sands",attended: false,),
      EventCard(title: "item 4",date: new DateTime(2020,DateTime.february,9), description: garbage,location: "Dover Poly",attended: false,),
      EventCard(title: "item 5",date: new DateTime(2020,DateTime.september,9), description: garbage,location: "City Hall",attended: true,),
