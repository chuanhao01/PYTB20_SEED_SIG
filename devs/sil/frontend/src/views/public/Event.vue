  ...
  <div class="event mx-auto">
    <div class="row">
      ...
      <div class="col-md-8 col-12 border mr-2 p-3 order-2 order-md-1">
        <h1>{{ event.items.eventName }}</h1>
        <p>{{ event.items.eventDesc }}</p>
      </div>
      ...
      <div class="col-md-3 col-12 border p-3 order-1 order-md-2">
        ...
        <span>
          ...
          {{event.items.eventDate}}
        </span>

        <button class="btn btn-primary w-100 mt-3 d-md-block d-none">Volunteer!</button>
      </div>
    </div>
    <div class="container-fluid w-100 border-top" id="volunteer-mobile">
      <div class="col-12 d-md-none d-flex w-100 h-100">
        <button class="btn btn-primary w-100 mt-3 d-md-none d-block mb-3">Volunteer!</button>
      </div>
    </div>
  </div>
</template>
