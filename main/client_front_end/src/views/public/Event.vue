  ...
  <div class="event mx-auto">
    <div class="row">
      ...
      <div class="col-md-3 col-12 border p-3 order-1 order-md-2">
        ...
        <button class="btn btn-primary w-100 mt-3 d-md-block d-none" @click="volunteer(event.items.event_id)" :class="{'btn-secondary' : event.items.signed_up}">Volunteer!</button>
      </div>
    </div>
    <div class="container-fluid w-100 border-top" id="volunteer-mobile">
      <div class="col-12 d-md-none d-flex w-100 h-100">
        <button class="btn btn-primary w-100 mt-3 d-md-none d-block mb-3" @click="volunteer(event.items.event_id)" :class="{'btn-secondary' : event.items.signed_up}">Volunteer!</button>
      </div>
    </div>
  </div>
</template>
